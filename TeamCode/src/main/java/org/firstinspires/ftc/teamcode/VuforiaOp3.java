...
public class VuforiaOp3 extends LinearOpMode {
...
//					upperLeft.getData()[0];
					...
					//
					// telemetry.addData(beac.getName() + "- Translation ",
					// translation);
					//
					// // if phone is in portrait 1 2
					// // if phone is in landscape 0 1
					// double degreesToTurn =
					// Math.toDegrees(Math.atan2(translation.get(1),
					// translation.get(2)));
					//
					// telemetry.addData(beac.getName() + "-degrees",
					// degreesToTurn);
				}
			}
			telemetry.update();
